...
<select name="id_sottocat" class="small">
	...
	<?php 
	$query_c="SELECT * FROM magazine_categorie WHERE id_cat='$argomento' ORDER BY ordine DESC";
...
&nbsp;<a href="admin.php?cmd=magazine_articolo_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=id_sottocat<?php echo $rif;?>">
