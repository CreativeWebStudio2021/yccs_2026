...
<script language="javascript">
	function verifica(){
		if (document.inserimento.pdf_eng.value=="") alert('Inserire Allegato (inglese)');
...
if($stato=="inviato")
{
	...
	$oggetto_admin->inserisci_campi ("members_calendario" , $arr_no ,  $arr_thumb="no", "");
?>
	<script language="javascript">
		window.location = "admin.php?cmd=members_calendario<?php  echo $rif; ?>" ;
	</script>
...
<div class="mws-panel grid_8">
	...
	<div class="mws-panel-body no-padding">
		<form name="inserimento" class="mws-form" action="admin.php?cmd=members_calendario_ins<?php  echo $rif; ?>" method="post" enctype="multipart/form-data">
