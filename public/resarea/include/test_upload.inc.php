...
<form id="uploadForm" action="test_upload_ajax.php" method="post">
	<div>
...
<div id="loader-icon" style="display:none;"><img src="https://rosariociaglia.altervista.org/pagine-prova/loader1/loader1.gif" /></div>