...
<script language="javascript">
	function annulla(){
		window.location='admin.php?cmd=loghi<?php echo $rif;?>';
	}
</script>
...
?>
	<script language="javascript">
		window.location='admin.php?cmd=loghi_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>';
	</script>	
<?php 
}
...
<div class="mws-panel grid_8">
	<div style="height:30px;font-size:1.2em;padding-top:10px">Modifica Risultato della regata <b><?php  echo ucfirst($nome_reg); ?></b> - <b>Edizione <?php  echo $anno_ed; ?></b></div>
	...
	<div class="mws-panel-body no-padding">
		<form name="inserimento" class="mws-form" action="admin.php?cmd=loghi_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>" method="post" enctype="multipart/form-data">
			...
			<div class="mws-form-inline">
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						...
						<a href="admin.php?cmd=loghi_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=titolo_eng<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a>
					</div>
				</div>
				...
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						<input type="text" class="medium" name="titolo" value="<?php  echo $n_titolo; ?>"/>
						<a href="admin.php?cmd=loghi_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=titolo<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a>
					</div>
				</div>
				...
				<div id="box_link">
					<div class="mws-form-row">
						...
						<div class="mws-form-item">
							...
							<?php if($n_link_eng && $n_link_eng!=""){?><a href="admin.php?cmd=loghi_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=link_eng<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a><?php }?>
						</div>
					</div>
					<div class="mws-form-row">
						...
						<div class="mws-form-item">
							...
							<?php if($n_link && $n_link!=""){?><a href="admin.php?cmd=loghi_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=link<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a><?php }?>
						</div>
					</div>
				</div>
				<div id="box_allegato">
					<?php 
					$oggetto_admin->campo_mod("Logo* (225x160)" , "img" , "$n_img"  , "4", 'no', "$cmd", "$id_rec$rif", "", "", "img_up/regate/loghi");
					?>
				</div>
