	...
	<div class="mws-panel-body no-padding">
		<form name="inserimento" class="mws-form" action="admin.php?cmd=<?php echo $table;?>_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>" method="post" enctype="multipart/form-data">
			...
			<div class="mws-form-inline">
				...
				$oggetto_admin->campo_mod("Video<br /><i>(formato mp4)</i>" , "video" , "$n_video"  , "5", 'no', "$cmd", "$id_rec", "", "", "files/slide");
				?>
				<div class="mws-form-row">
					<label class="mws-form-label">Didascalia - Riga 1</label>
					<div class="mws-form-item">
						<input type="text" class="medium" name="riga1" value="<?php  echo $n_riga1; ?>"/>
						<a href="admin.php?cmd=slide_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=riga1<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a>
					</div>
				</div>
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						...
						<a href="admin.php?cmd=slide_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=riga2<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a>
					</div>
				</div>
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						...
						<a href="admin.php?cmd=slide_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=riga3<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a>
					</div>
				</div>
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						...
						<a href="admin.php?cmd=slide_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=link<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a>
					</div>
				</div>
				<!--<div class="mws-form-row">
