...
<script language="javascript">
	function annulla(){
		window.location='admin.php?cmd=loghi_new<?php echo $rif;?>';
	}
</script>
...
?>
	<script language="javascript">
		window.location='admin.php?cmd=loghi_new_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>';
	</script>	
<?php 
}
...
if($stato=="inviato")
{
	...
	$oggetto_admin->modifica_campi ("$table" ,$id_rec , $arr_no ,  $arr_thumb, "img_up/regate/loghi");
?>
	<script language="javascript">
		window.location='admin.php?cmd=loghi_new<?php echo $rif;?>';
	</script>	
...
<div class="mws-panel grid_8">
	<div style="height:50px;font-size:1.2em;padding-top:10px">Modifica Loghi Carosello della regata <b><?php  echo ucfirst($nome_reg); ?></b> - <b>Edizione <?php  echo $anno_ed; ?></b></div>
	
	<div style="display:flex; justify-content:space-between;">
		<a href="admin.php?cmd=loghi_new<?php echo $rif;?>" style="color:#7a7a7a">
	...
	<div class="mws-panel-body no-padding">
		<form name="inserimento" class="mws-form" action="admin.php?cmd=loghi_new_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>" method="post" enctype="multipart/form-data">
			...
			<div class="mws-form-inline">
				...
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						...
						<a href="admin.php?cmd=loghi_new_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=titolo<?php echo $rif;?>"><i style="font-size:1.5em;" class="fa fa-eraser" aria-hidden="true"></i></a>
					</div>
				</div>
				...
				<div id="box_link">
					<div class="mws-form-row">
						...
						<div class="mws-form-item">
							...
							<?php if($n_link_eng && $n_link_eng!=""){?><a href="admin.php?cmd=loghi_new_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=link_eng<?php echo $rif;?>"><i style="font-size:1.5em;" class="fa fa-eraser" aria-hidden="true"></i></a><?php }?>
						</div>
					</div>
					<div class="mws-form-row">
						...
						<div class="mws-form-item">
							...
							<?php if($n_link && $n_link!=""){?><a href="admin.php?cmd=loghi_new_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=link<?php echo $rif;?>"><i style="font-size:1.5em;" class="fa fa-eraser" aria-hidden="true"></i></a><?php }?>
						</div>
					</div>
				</div>
				<div id="box_allegato">
