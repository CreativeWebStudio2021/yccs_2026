...
$rif="";
$rif.="&pag_att=$pag_att";
if($ric_covid!="") $rif .= "&ric_covid=$ric_covid";
?>
...
?>
	<script language="javascript">
		window.location='admin.php?cmd=news_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>';
	</script>	
<?php 
}
...
<div class="mws-panel grid_8">
	...
	<div style="display:flex; justify-content:space-between;">
		<a href="admin.php?cmd=news<?php echo $rif;?>" style="color:#7a7a7a">
			<div class="newAdminBott2">
				<i class="fa fa-caret-left" aria-hidden="true"></i>
				&nbsp;
				<b>Torna all'elenco delle news</b>
			</div>
		</a>
		<div></div>
	</div>
	...
	<div class="mws-panel-body no-padding">
		<form name="gino" class="mws-form" action="admin.php?cmd=news_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>" method="post" enctype="multipart/form-data">
			...
			<div class="mws-form-row">
				...
				<div class="mws-form-item">
					...
					<a href="admin.php?cmd=news_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=titolo_eng<?php echo $rif;?>">
			...
			<?php /*
			<div class="mws-form-row">
				<label class="mws-form-label">COVID-19</label>
				<div class="mws-form-item">
					<select name="covid">
						<option value='0' <?php if($n_covid==0){?>selected="selected"<?php }?>>No</option>
						<option value='1' <?php if($n_covid==1){?>selected="selected"<?php }?>>S&igrave;</option>
					</select>
				</div>
			</div>
			*/?>
			...
			?>
				...
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						...
						<a href="admin.php?cmd=news_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=testo_eng<?php echo $rif;?>">
							<i style="font-size:1.5em;" class="fa fa-eraser" aria-hidden="true"></i>
						</a>
					</div>
				</div>
				...
				<div style="margin-left:20px; padding-bottom:10px;">	
					<i style="font-size:1.5em;" class="fa fa-eraser" aria-hidden="true"></i> <i>cliccando sulla gomma che compare vicino ad un campo si cancella il contenuto del campo stesso</i>
				</div>
			</div>
