...
if($stato=="inviato")
{
	...
	$oggetto_admin->inserisci_campi ("edizioni_doc" , $arr_no ,  $arr_thumb="no", "", "files/regate/doc");
?>
	<script language="javascript">
		window.location = "admin.php?cmd=documenti<?php  echo $rif; ?>" ;
	</script>
...
<div class="mws-panel grid_8">
	<div style="height:50px;font-size:1.2em;padding-top:10px">Inserisci Documento della regata <b><?php  echo ucfirst($nome_reg); ?></b> - <b>Edizione <?php  echo $anno_ed; ?></b><!-- (Dim. img 1920 x 1280 pixel)--></div>
	...
	<div class="mws-panel-body no-padding">
		<form name="inserimento" class="mws-form" action="admin.php?cmd=documenti_ins<?php  echo $rif; ?>" method="post" enctype="multipart/form-data">
