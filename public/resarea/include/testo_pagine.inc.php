			...
			<tbody>					
				<?php /*<tr>
					...
					<td style="text-align:center;">
						<?php 
						$query_foto="SELECT id FROM testo_pagine WHERE pagina='one-ocean'";
						$resu_foto=$open_connection->connection->query($query_foto);
						$num_foto=$resu_foto->rowCount();
						?>
						<a href="admin.php?cmd=testo_pagine_ins&pagina=one-ocean" style="color:#2a2a2d">
							<i class="fa fa-pencil-square-o" aria-hidden="true" <?php if($num_text>0){?>style="color:green"<?php }?>></i>
						</a>		
					</td>						
				</tr>				*/?>
				<tr>
					...
					<td style="text-align:center;">
						<?php 
						$query_text="SELECT id FROM testo_pagine WHERE pagina='yccs_sostenibilita'";
						$resu_text=$open_connection->connection->query($query_text);
						$num_text=$resu_text->rowCount();
						?>
						<a href="admin.php?cmd=testo_pagine_ins&pagina=yccs_sostenibilita" class="btn btn-sm" style="color:#2a2a2d">
							<i class="fa fa-pencil-square-o" aria-hidden="true" <?php if($num_text>0){?>style="color:green"<?php }?>></i>
						</a>						
					</td>						
				</tr>					
				<?php /*<tr>
					...
					<td style="text-align:center;">
						<?php 
						$query_foto="SELECT id FROM testo_pagine WHERE pagina='charta_smeralda'";
						$resu_foto=$open_connection->connection->query($query_foto);
						$num_foto=$resu_foto->rowCount();
						?>
						<a href="admin.php?cmd=testo_pagine_ins&pagina=charta_smeralda" style="color:#2a2a2d">
							<i class="fa fa-pencil-square-o" aria-hidden="true" <?php if($num_text>0){?>style="color:green"<?php }?>></i>
						</a>						
					</td>						
				</tr>	*/?>				
				<tr>
					...
					<td style="text-align:center;">
						<?php 
						$query_text="SELECT id FROM testo_pagine WHERE pagina='yccs_clean_beach_day'";
						$resu_text=$open_connection->connection->query($query_text);
						$num_text=$resu_text->rowCount();
						?>
						<a href="admin.php?cmd=testo_pagine_ins&pagina=yccs_clean_beach_day" class="btn btn-sm" style="color:#2a2a2d">
							<i class="fa fa-pencil-square-o" aria-hidden="true" <?php if($num_text>0){?>style="color:green"<?php }?>></i>
						</a>
					</td>						
				</tr>
