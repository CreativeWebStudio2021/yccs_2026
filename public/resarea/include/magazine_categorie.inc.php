...
<div class="mws-panel grid_8">
	<div style="height:30px;font-size:1.2em;padding-top:10px"><b>Categorie Magazine</b></div>
	<p>
	...
	<div class="mws-form-item" style="float:left;width:50%">
		<label class="mws-form-label"><b>Argomenti</b> &nbsp; </label>
		<select name="id_cat" class="small" onchange="window.location='admin.php?cmd=magazine_categorie&id_cat='+this.value">
			<option value="">- Seleziona -</option>
			<?php 
			$query_cat="SELECT * FROM magazine_macrocategorie ORDER BY nome";
		...
		<table class="mws-datatable-fn mws-table">
			...
			<?php 
				...
				{					  
					...
					{						
						...
						$nome_macro = "";
						$query_macro = "select nome from magazine_macrocategorie where id='$id_macro'";
						$risu_macro = $open_connection->connection->query($query_macro);
						if ($risu_macro) list($nome_macro) = $risu_macro->fetch();
						
						$query_p = "SELECT * FROM magazine_articolo WHERE id_sottocat='$id_campo'";
			...
			?>
				...
				<tr>
					...
					<td align="center">
						<a href="admin.php?cmd=magazine_articolo&macro_ric=<?php echo $id_macro;?>&cat_ric=<?php echo $id_campo;?>" class="btn btn-small"><?php echo $num_p;?></a>					
					</td>
					<td style="width:10%">
