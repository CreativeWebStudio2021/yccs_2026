...
if($stato=="inviato")
{
	...
	$oggetto_admin->inserisci_campi("$table" , $arr_no ,  $arr_thumb, "img_up/images", "", "800");*/
	...
	for($x=0; $x<count ($_FILES['immagine']['name']); $x++){
		...
		if ($nome_file) {		
			...
			$nome_file =  $oggetto_admin->scrivi_img($nome_file , $temp_file, "img_up/images");
			
			list($larghezza_gr , $height, $type, $attr) = getimagesize($temp_file);
			if ($larghezza_gr>800) $oggetto_admin->thumbjpg_new(800,$temp_file,$nome_file,"img_up/images");			
			
			$query_ins_file = "insert into immagini (immagine) values ('$nome_file')";
...
<div class="mws-panel grid_8">
	<div style="height:50px;font-size:1.2em;padding-top:10px"><b>Inserisci Immagine</b></div>
	...
	<div style="display:flex; justify-content:space-between;">
		<a href="admin.php?cmd=<?php echo $table;?><?php echo $rif;?>" style="color:#7a7a7a">
			<div class="newAdminBott2">
				...
				&nbsp;
				<b>Torna all'elenco delle immagini</b>
			</div>
		</a>
		<div></div>
	</div>
	...
	<?php 
				$oggetto_admin->campo_ins("Immagine *<br />" , "immagine" , "42", 'no');
	?>
