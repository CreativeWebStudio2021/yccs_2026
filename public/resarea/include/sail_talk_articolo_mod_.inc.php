	...
	<div class="mws-panel grid_8">
		...
		<div style="float:left; margin-left:20px; height:50px;font-size:1.2em;padding-top:10px">
			...
			<a href="<?php echo $link_sail_talk;?>" target="_blank" style="text-decoration: none">
				<div style="width:140px; background:red; text-align:center; color:#fff; border-radius:4px; z-index:1000000">
		...
		<div class="mws-panel-body no-padding">
				...
				<div class="mws-form-inline">
					<div class="mws-form-row">
						...
						<div class="mws-form-item">
							...
							&nbsp;<a href="admin.php?cmd=sail_talk_articolo_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=id_cat<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a>
						</div>
					</div>
					...
					<div class="mws-form-row">
						...
						<div class="mws-form-item">
							...
							<a href="admin.php?cmd=sail_talk_articolo_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=testo_eng<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a>
						</div>
					</div>*/?>
					<br/><br/>
			...
			while($risu_b=$resu_b->fetch()){
				...
				<form class="mws-form">
					<div class="mws-button-row">
						<div style="float:left; width: -webkit-calc(100% - 200px); width:-moz-calc(100% - 200px); width:calc(100% - 200px); cursor:pointer;" onclick="vedi_blocco('<?php echo $id_blocco;?>');">
							<span id="blocco_bott_<?php echo $id_blocco;?>"><i class="fa fa-plus" aria-hidden="true"></i></span>&nbsp;&nbsp;<b>Blocco Pagina <?php echo $x;?> (<?php echo ucWords(str_replace("_"," ",$n_tipo));?>)</b>
						</div>
				...
				<div class="mws-form-inline" id="blocco_<?php echo $id_blocco;?>" style="display:none">
						...
						<div class="mws-form-row">
							...
							<div class="mws-form-item">
								...
								for($i=1; $i<=count($array_stili); $i++){?>							
									<div style="float:left; text-align:center; border:solid 1px; margin-right:10px; border-radius:7px; <?php if($n_tipo==$array_stili[$i]){?>background:#D2D2D2<?php }?>" id="<?php echo $array_stili[$i];?>_mod_<?php echo $id_blocco;?>">
					...
					<form style="display:<?php if($n_tipo=="testo_immagine"){?>block<?php }else{?>none<?php }?>"  name="mod_blocco_testo_immagine_<?php echo $id_blocco;?>" id="mod_blocco_testo_immagine_<?php echo $id_blocco;?>" class="mws-form" action="admin.php?cmd=sail_talk_articolo_mod&id_rec=<?php  echo $id_rec; ?>&id_rec_blocco=<?php echo $id_blocco;?><?php echo $rif;?>" method="post" enctype="multipart/form-data">
						...
						<?php 
						$oggetto_admin->campo_mod("Foto<br /><i>(Dim. 1920 pixel)</i>" , "immagine" , "$n_immagine"  , "4", 'no', "$cmd", "$id_rec", "", "", "img_up/sail_talk");
						?>
						<div class="mws-button-row" id="blocco_<?php echo $x;?>_button_box">
			...
			<div class="mws-form-inline" id="blocco_<?php echo $x;?>">
				<form class="mws-form">
					<div class="mws-form-row">
						...
						<div class="mws-form-item">
							<?php 
							for($i=1; $i<=count($array_stili); $i++){?>
								<div style="float:left; text-align:center; border:solid 1px; margin-right:10px; border-radius:7px;" id="<?php echo $array_stili[$i];?>">
									<div style="padding:5px 15px; cursor:pointer;" onclick="cambiaStile('<?php echo $array_stili[$i];?>')">
										<?php echo ucWords(str_replace("_"," ",$array_stili[$i]));?><br/>
										<?php //<span id="solo_testo_bott"><i class="fa fa-circle-o" style="font-size:1.3em" aria-hidden="true"></i></span>*/?>
									</div>
								</div>
							<?php }?>
							
							<?php /*<div style="float:left; text-align:center; border:solid 1px; margin-right:10px" id="solo_immagine">
								<div style="padding:8px 15px; cursor:pointer;" onclick="cambiaStile('solo_immagine','0')">
									Solo Immagine<br/>
									<?php //<span id="solo_immagine_bott"><i class="fa fa-circle-o" style="font-size:1.3em" aria-hidden="true"></i></span>
								</div>
							</div>
							<div style="float:left; text-align:center; border:solid 1px; margin-right:10px" id="immagine_testo">
								<div style="padding:8px 15px; cursor:pointer;" onclick="cambiaStile('immagine_testo','0')">
									Immagine/Testo<br/>
									<?php //<span id="immagine_testo_bott"><i class="fa fa-circle-o" style="font-size:1.3em" aria-hidden="true"></i></span>
								</div>
							</div>
							<div style="float:left; text-align:center; border:solid 1px; margin-right:10px" id="testo_immagine">
								<div style="padding:8px 15px; cursor:pointer;" onclick="cambiaStile('testo_immagine','0')">
									Testo/Immagine<br/>
									<?php //<span id="testo_immagine_bott"><i class="fa fa-circle-o" style="font-size:1.3em" aria-hidden="true"></i></span>
								</div>
							</div>
							<div style="float:left; text-align:center; border:solid 1px; margin-right:10px" id="gallery">
								<div style="padding:8px 15px; cursor:pointer;" onclick="cambiaStile('gallery','0')">
									Gallery<br/>
									<?php //<span id="gallery_bott"><i class="fa fa-circle-o" style="font-size:1.3em" aria-hidden="true"></i></span>
								</div>
							</div>*/?>
						</div>
					</div>
				...
				<script>
					function cambiaStile(stile){
						/*document.getElementById('solo_testo_bott').innerHTML='<i class="fa fa-circle-o" style="font-size:1.3em" aria-hidden="true"></i>';
						document.getElementById('solo_immagine_bott').innerHTML='<i class="fa fa-circle-o" style="font-size:1.3em" aria-hidden="true"></i>';
						document.getElementById('immagine_testo_bott').innerHTML='<i class="fa fa-circle-o" style="font-size:1.3em" aria-hidden="true"></i>';
						document.getElementById('testo_immagine_bott').innerHTML='<i class="fa fa-circle-o" style="font-size:1.3em" aria-hidden="true"></i>';
						document.getElementById('gallery_bott').innerHTML='<i class="fa fa-circle-o" style="font-size:1.3em" aria-hidden="true"></i>';
						*/
