...
<script language="javascript">
	function verifica(){
		if (document.inserimento.img.value=="") alert('Logo obbligatorio');
...
if($stato=="inviato")
{
	...
	$oggetto_admin->inserisci_campi ("edizioni_loghi" , $arr_no ,  $arr_thumb="no", "img_up/regate/loghi");
?>
	<script language="javascript">
		window.location = "admin.php?cmd=loghi<?php  echo $rif; ?>" ;
	</script>
...
<div class="mws-panel grid_8">
	<div style="height:50px;font-size:1.2em;padding-top:10px">Inserisci Logo nella regata <b><?php  echo ucfirst($nome_reg); ?></b> - <b>Edizione <?php  echo $anno_ed; ?></b><!-- (Dim. img 1920 x 1280 pixel)--></div>
	<div class="mws-panel-header">
		<span>Dati richiesti</span>
	</div>
	<div class="mws-panel-body no-padding">
		<form name="inserimento" class="mws-form" action="admin.php?cmd=loghi_ins<?php  echo $rif; ?>" method="post" enctype="multipart/form-data">
			...
			<div class="mws-form-inline">
				...
				$oggetto_admin->campo_ins("Logo* (225x160)" , "img" , "4", 'no');
				?>
				<br/><br/>
