...
if($stato=="inviato")
{
	...
	$oggetto_admin->inserisci_campi ("edizioni_iscritti" , $arr_no ,  $arr_thumb="no", "", "files/regate/iscritti");
?>
	<script language="javascript">
		window.location = "admin.php?cmd=iscritti<?php  echo $rif; ?>" ;
	</script>
...
<div class="mws-panel grid_8">
	<div style="height:50px;font-size:1.2em;padding-top:10px">Inserisci Iscritto della regata <b><?php  echo ucfirst($nome_reg); ?></b> - <b>Edizione <?php  echo $anno_ed; ?></b><!-- (Dim. img 1920 x 1280 pixel)--></div>
	...
	<div class="mws-panel-body no-padding">
		<form name="inserimento" class="mws-form" action="admin.php?cmd=iscritti_ins<?php  echo $rif; ?>" method="post" enctype="multipart/form-data">
			...
			<div class="mws-form-inline">
				...
				<div id="box_allegato" style="display:none">
					...
					<?php /*<div class="mws-form-row">
						...
						<div class="mws-form-item">
							<input name="slug" type="text" class="medium" value="" id="slug" autocomplete="off" onkeyup="checkSlug(this.value);">
						</div>
					</div>
				...
				<script type="text/javascript">
					...
					function checkSlug(slug){
						$.ajax({
							...
							type: "GET",
							data: {slug : slug, id_riferimento : '<?php echo $id_riferimento;?>'}, 
