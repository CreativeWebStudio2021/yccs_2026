...
<div class="mws-panel grid_8">
	...
	<div class="mws-form-item">
		<select name="id_rife" class="small" onchange="window.location='admin.php?cmd=sottocategorie&id_rife='+this.value">
	...
	<div class="mws-panel-body no-padding">
		<table class="mws-datatable-fn mws-table">
			...
			<tbody>
			<?php 
				$query_ele = "SELECT * FROM $table WHERE 1 $criterio ORDER BY id_rife ASC, ordine DESC";
				...
				{					  
					...
					{						
						...
						$google = $arr_ele['categoria_google'];
						
						$query_cat="SELECT nome FROM categorie WHERE id='$id_cat'";
						$resu_cat=$open_connection->connection->query($query_cat);
						list($cat)=$resu_cat->fetch();
						
						$num_prod = 0;
						$query_p = "select * from prodotti where id_rife='$id_cat' and id_riferimento='$id_campo'";
						$risu_p = $open_connection->connection->query($query_p);
						if ($risu_p) $num_prod = $risu_p->rowCount();
			?>
				<script type="text/javascript">
				...
				<tr>
					...
					<td>
						...
						<?php if($arr_ele['nome_eng'] && $arr_ele['nome_eng']!=""){?><img src="../images/en.gif" alt="" style="width:10px;"/>&nbsp;<?php  echo $arr_ele['nome_eng']; ?><?php }?>
					</td>
					<td><?php  echo $cat; ?></td>
					<td style="width:10%">
