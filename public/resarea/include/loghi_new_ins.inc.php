...
if($stato=="inviato")
{
	...
	$oggetto_admin->inserisci_campi ("edizioni_loghi_new" , $arr_no ,  $arr_thumb, "img_up/regate/loghi");
?>
	<script language="javascript">
		window.location = "admin.php?cmd=loghi_new<?php  echo $rif; ?>" ;
	</script>
...
<div class="mws-panel grid_8">
	...
	<div class="mws-panel-body no-padding">
		<form name="inserimento" class="mws-form" action="admin.php?cmd=loghi_new_ins<?php  echo $rif; ?>" method="post" enctype="multipart/form-data">
