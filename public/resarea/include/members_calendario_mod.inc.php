...
<script language="javascript">
	function annulla(){
		window.location='admin.php?cmd=members_calendario<?php echo $rif;?>';
	}
</script>
...
?>
	<script language="javascript">
		window.location='admin.php?cmd=members_calendario_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>';
	</script>	
<?php 
}
...
<div class="mws-panel grid_8">
	<div style="height:30px;font-size:1.2em;padding-top:10px"><b>Modifica Documento</b></div>
	...
	<div class="mws-panel-body no-padding">
		<form name="inserimento" class="mws-form" action="admin.php?cmd=members_calendario_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>" method="post" enctype="multipart/form-data">
