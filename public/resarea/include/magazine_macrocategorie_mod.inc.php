	...
	<div style="display:flex; justify-content:space-between;">
		<a href="admin.php?cmd=<?php echo $table;?><?php echo $rif;?>" style="color:#7a7a7a">
			<div class="newAdminBott2">
				...
				&nbsp;
				<b>Torna all'elenco degli argomenti</b>
			</div>
		</a>
		<div></div>
	</div>
			...
			<div class="mws-form-inline">
				...
				<!--<div class="mws-form-row">
					...
					<div class="mws-form-item">
						...
						<a href="admin.php?cmd=<?php echo $table;?>_mod&id_rec=<?php echo $id_rec;?>&campocanc=descr<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a>
					</div>
				</div>-->
				<br/><br/>
