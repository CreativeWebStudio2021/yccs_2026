...
$query_rec = "select * from documenti_stampa where id='$id_rec'";
...
?>
	<script language="javascript">
		window.location='admin.php?cmd=documentis_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>';
	</script>	
<?php 
}
...
<div class="mws-panel grid_8">
	<div style="height:50px;font-size:1.2em;padding-top:10px">Modifica Documento per l'articolo <b><?php  echo ucfirst($nome_reg); ?></b> in <b>Ufficio Stampa</b></div>
	...
	<div class="mws-panel-body no-padding">
		<form name="inserimento" class="mws-form" action="admin.php?cmd=documentis_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>" method="post" enctype="multipart/form-data">
