...
if($stato=="inviato")
{
	...
	$oggetto_admin->inserisci_campi ("rassegna_video" , $arr_no ,  $arr_thumb="no");
?>
	<script language="javascript">
		window.location = "admin.php?cmd=rassegna_video<?php  echo $rif; ?>" ;
	</script>
...
<div class="mws-panel grid_8">
	<div style="height:50px;font-size:1.2em;padding-top:10px">Inserisci Video della conferenza stampa <b><?php  echo ucfirst($nome_reg); ?></b><!-- (Dim. img 1920 x 1280 pixel)--></div>
	...
	<div class="mws-panel-body no-padding">
		<form name="inserimento" class="mws-form" action="admin.php?cmd=rassegna_video_ins<?php  echo $rif; ?>" method="post" enctype="multipart/form-data">
			...
			<?php 
			$ord_ev = $oggetto_admin->trova_ordine2("$table", "id_rassegna", $id_rife, "id_edizione", $id_riferimento);
