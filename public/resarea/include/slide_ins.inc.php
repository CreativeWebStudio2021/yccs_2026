...
if($stato=="inviato")
{
	...
	$oggetto_admin->inserisci_campi("$table" , $arr_no ,  $arr_thumb, "img_up/slide", "files/slide");
?>
	<script language="javascript">
		window.location = "admin.php?cmd=<?php echo $table;?><?php echo $rif;?>" ;
	</script>
...
<div class="mws-panel grid_8">
	<div style="height:50px;font-size:1.2em;padding-top:10px"><b>Inserisci slide</b></div>
