...
<div class="mws-panel grid_8">
	<div style="height:30px;font-size:1.2em;padding-top:10px"><b>Argomenti Magazine</b></div>
	</p>
		...
		<table class="mws-datatable-fn mws-table">
			...
			<?php 
				...
				{					  
					...
					{						
						...
						$query_p = "SELECT * FROM magazine_categorie WHERE id_cat='$id_campo'";
						$risu_p = $open_connection->connection->query($query_p);
						$num_p=$risu_p->rowCount();
						
						$query_p = "SELECT id FROM magazine_articolo WHERE id_cat='$id_campo'";
						$risu_p = $open_connection->connection->query($query_p);
			...
			?>
				...
				<tr>
					...
					<td><?php  echo $nome; ?></td>
					<td align="center">
						<a href="admin.php?cmd=magazine_categorie&id_cat=<?php echo $id_campo;?>" class="btn btn-small"><?php echo $num_p;?></a>					
					</td>
					<td align="center">
						<a href="admin.php?cmd=magazine_articolo&macro_ric=<?php echo $id_campo;?>" class="btn btn-small"><?php echo $num_p2;?></a>					
					</td>
					<td style="width:10%">
