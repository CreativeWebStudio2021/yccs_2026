...
if($azione=="cancella" && $id_canc!="")
{
	...
	if ($risu_canc_img) {
		...
		if (is_file("img_up/macro/$foto")) @unlink("img_up/macro/$foto");
		if (is_file("img_up/macro/s_$foto")) @unlink("img_up/macro/s_$foto");
	}*/
...
if($azione=="cancella_sel") {
	...
	for($z=0; $z<count($temp)-1; $z++){
		...
		if ($risu_canc_img) {
			...
			if (is_file("img_up/macro/$img")) @unlink("img_up/macro/$img");
			if (is_file("img_up/macro/s_$img")) @unlink("img_up/macro/s_$img");
		}
...
<div class="mws-panel grid_8">
	<div style="height:30px;font-size:1.2em;padding-top:10px"><b>Argomenti Sail Talk</b></div>
	</p>
	...
	<div class="mws-panel-header">
		<span><i class="icon-table"></i> Elenco Argomenti</span>
	</div>
		...
		<table class="mws-datatable-fn mws-table">
			...
			<?php 
				...
				{					  
					...
					{						
						...
						$query_p = "SELECT * FROM sail_talk_categorie WHERE id_cat='$id_campo'";
			...
			?>
				...
				<tr>
					...
					<td><?php  echo $nome; ?></td>
					<td align="center">
						<a href="admin.php?cmd=sail_talk_categorie&id_cat=<?php echo $id_campo;?>" class="btn btn-small"><?php echo $num_p;?></a>
					</td>
					<td align="center">
						<a href="admin.php?cmd=sail_talk_articolo&id_cat_ric=<?php echo $id_campo;?>" class="btn btn-small"><?php echo $num_p2;?></a>
					</td>
					<td style="width:10%">
