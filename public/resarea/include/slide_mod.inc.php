...
if($campocanc!="")
{
	...
	if(is_file("img_up/slide/$cancimg")){unlink("img_up/slide/$cancimg");}
...
?>
	<script language="javascript">
		window.location='admin.php?cmd=slide_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>';
	</script>	
<?php 
}
...
if($stato=="inviato")
{
	...
	$oggetto_admin->modifica_campi("$table" ,$id_rec , $arr_no ,  $arr_thumb, "img_up/slide", "files/slide");
?>
	<script language="javascript">
		window.location = "admin.php?cmd=<?php echo $table;?><?php echo $rif;?>" ;
	</script>
...
<div class="mws-panel grid_8">
	<div style="height:50px;font-size:1.2em;padding-top:10px"><b>Modifica slide</b></div>
	
	<div style="display:flex; justify-content:space-between;">
		<a href="admin.php?cmd=slide<?php echo $rif;?>" style="color:#7a7a7a">
	...
	<div class="mws-panel-body no-padding">
		<form name="inserimento" class="mws-form" action="admin.php?cmd=<?php echo $table;?>_mod&id_rec=<?php  echo $id_rec; ?><?php echo $rif;?>" method="post" enctype="multipart/form-data">
			...
			<div class="mws-form-inline">
				<?php 
				$oggetto_admin->campo_mod("Foto *<br /><i>(Dim. 1920x1080 pixel)</i>" , "img" , "$n_img"  , "4", 'no', "$cmd", "$id_rec", "", "", "img_up/slide");
				$oggetto_admin->campo_mod("Video<br /><i>(formato mp4, max 30Mb)</i>" , "video" , "$n_video"  , "5", 'no', "$cmd", "$id_rec", "", "", "img_up/slide", "files/slide");
				?>
				<div class="mws-form-row">
					<label class="mws-form-label">Didascalia - Riga 1</label>
					<div class="mws-form-item">
						<input type="text" class="medium" name="riga1" value="<?php  echo $n_riga1; ?>"/>
						<a href="admin.php?cmd=slide_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=riga1<?php echo $rif;?>" alt="Cancella il contenuto del campo"><i style="font-size:1.5em;" class="fa fa-eraser" aria-hidden="true"></i></a>
					</div>
				</div>
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						...
						<a href="admin.php?cmd=slide_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=riga2<?php echo $rif;?>" alt="Cancella il contenuto del campo"><i style="font-size:1.5em;" class="fa fa-eraser" aria-hidden="true"></i></a>
					</div>
				</div>
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						...
						<a href="admin.php?cmd=slide_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=riga3<?php echo $rif;?>" alt="Cancella il contenuto del campo"><i style="font-size:1.5em;" class="fa fa-eraser" aria-hidden="true"></i></a>
					</div>
				</div>
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						...
						<a href="admin.php?cmd=slide_mod&id_rec=<?php  echo $id_rec; ?>&campocanc=link<?php echo $rif;?>" alt="Cancella il contenuto del campo"><i style="font-size:1.5em;" class="fa fa-eraser" aria-hidden="true"></i></a>
					</div>
				</div>
				<!--<div class="mws-form-row">
