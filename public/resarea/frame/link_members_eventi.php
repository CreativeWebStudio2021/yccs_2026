...
if($azione=="cancella_sel") {
	...
	for($z=0; $z<count($temp)-1; $z++){
		...
		<script type="text/javascript">
			window.location='http://<?php if($local) echo str_replace("yccs/","",$ind_sito); else echo $ind_sito?>/resarea/frame/link_members_eventi.php?id_comm=<?php echo $id_comm;?>';
		</script>
	<?php 	
}
...
if($azione=="visibile") {
	...
	?>
	<script type="text/javascript">
		window.location='<?php echo $http;?>://<?php if($local) echo str_replace("yccs/","",$ind_sito); else echo $ind_sito?>/resarea/frame/link_members_eventi.php?id_comm=<?php echo $id_comm;?>';
	</script>
	<?php 
}
...
<body style="background:#fff">
	...
	<div class="mws-panel grid_8">
		<div style="height:50px;font-size:1.2em;padding-top:10px"><b>Eventi Eventi Young Azzurra - Link</b></div>
		...
		<div id="inserisci">
			<div class="mws-panel-header">
				<span>Inserisci Link Evento</span>
			</div>
