...
<body style="background:#fff">
	...
	<div class="mws-panel grid_8">
		<div style="height:50px;font-size:1.2em;padding-top:10px"><b>Video News</b></div>

		<div id="start" style="display:none"></div>
		<div id="end" style="display:none"></div>
		<div id="total" style="display:none"></div>
		
		<div class="btn" onclick="annulla();"><i class="fa fa-plus-circle"></i> Inserisci Video</div>
			...
			<div class="mws-panel-body no-padding" style="margin-top:40px">
				<form class="mws-form"  action="<?php echo $_SERVER['REQUEST_URI'];?>" method="post" name="invia_foto" enctype="multipart/form-data" style="margin-top:-40px">			
					...
					<div class="mws-form-inline">
						<script type="text/javascript">
							function annulla(){
								document.invia_foto.video.value="";
						...
						?>
						<?php 
							$oggetto_admin->campo_ins("Link Video" , "video" , "1", 'no');
						?>
						<div style="margin:0 20px 10px; font-size:1em; line-height:1.2em">
							Possono essere inseriti video da Facebook e Youtube nelle seguenti forme:<br/>
							Youtube -> https://www.youtube.com/watch?v=xxxxxxxxxxx<br/>
							Facebook -> https://www.facebook.com/1192153645/videos/xxxxxxxxxxxxxxxx
						</div>						
			...
			<table class="mws-datatable-fn mws-table">
				<thead>
					<tr>
						...
						<th style="width:150px">Anterpima</th>
						<th>Link</th>
					...
					{		
						...
						{						
							...
							if($tipo=="youtube"){
								...
								$codice=substr($temp[1],0,11);
								
								$anteprima = '<img alt="" src="http://i4.ytimg.com/vi/'.$codice.'/hqdefault.jpg" style="width:220px;"/>';
								
								$embed .= '<div style="width:86%; margin:20px 0; margin-left:7%; min-height:30px; background:#F0F0F0">';
									$embed .= '<iframe  width="560" height="315" src="https://www.youtube.com/embed/'.$codice.'?rel=0" frameborder="0" allowfullscreen></iframe>	';
								$embed .= '</div>';
								
								$embed = '<img alt="" src="'.$http.'://'.$ind_sito.'/resarea/img/thumb_default.png?'.$id_campo.'" style="width:86%;  margin:20px 0; margin-left:7%;"/>';
							}
							if($tipo=="facebook"){
								$temp=explode("videos/",$video);
								$codice=str_replace("/","",$temp[1]);
								
								$anteprima .= '<div style="position:relative; width:220px;">';
									$anteprima .= '<div style="position:absolute; width:100%; height:100%;"></div>';
									$anteprima .= '<div class="fb-video" data-href="https://www.facebook.com/facebook/videos/'.$codice.'/"  data-show-text="false" style="width:100%;">													';
								$anteprima .= '</div>';
								
								$embed .= '<div style="position:relative; width:86%; margin:20px 0; margin-left:7%; min-height:30px; background:#F0F0F0">';
									$embed .= '<div style="position:absolute; width:100%; height:100%;"></div>';
									$embed .= '<div class="fb-video" data-href="https://www.facebook.com/facebook/videos/'.$codice.'/"  data-show-text="false" style="width:100%;">													';
								$embed .= '</div>';
								$embed = '<img alt="" src="'.$http.'://'.$ind_sito.'/resarea/img/thumb_default.png?'.$id_campo.'" style="width:86%;  margin:20px 0; margin-left:7%;"/>';
							}
