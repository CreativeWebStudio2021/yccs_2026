...
if($stato=="inviato"){
	...
	?>
		<script language="javascript">
			window.location = "<?php echo $http;?>://<?php echo $ind_sito?>/resarea/frame/link_comunicati.php?id_comm=<?php echo $id_comm;?>" ;
		</script>
	<?php 
}
...
?>
	<script language="javascript">
		window.location='<?php echo $http;?>://<?php echo $ind_sito?>/resarea/frame/link_comunicati_mod.php?id_comm=<?php echo $id_comm;?>&id_canc=<?php echo $id_canc;?>';
	</script>	
<?php 
}
	...
	<div class="mws-panel grid_8">
		...
		<div id="inserisci">
			<div class="mws-panel-header">
				<span>Modifica Link Comunicato Home</span>
			</div>
						...
						<div style="display:block" id="box_testo">
							...
							<div class="mws-form-row">
								...
								<div class="mws-form-item">
									...
									<?php if($n_testo && $n_testo!=""){?><a href="frame/link_comunicati_mod.php?id_comm=<?php echo $id_comm;?>&id_canc=<?php  echo $id_canc; ?>&campocanc=testo<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a><?php }?>
								</div>
							</div>
						</div>
						<div id="box_link" style="display:<?php if($n_tipo=="link"){?>block<?php }else{?>none<?php }?>">
							<div class="mws-form-row">
								...
								<div class="mws-form-item">
									...
									<a href="frame/link_comunicati_mod.php?id_comm=<?php echo $id_comm;?>&id_canc=<?php  echo $id_canc; ?>&campocanc=link_eng<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a>
								</div>
							</div>
							<div class="mws-form-row">
								...
								<div class="mws-form-item">
									...
									<?php if($n_link && $n_link!=""){?><a href="frame/link_comunicati_mod.php?id_comm=<?php echo $id_comm;?>&id_canc=<?php  echo $id_canc; ?>&campocanc=link<?php echo $rif;?>"><img align="middle" src="img/erasure.png" alt="Cancella il contenuto del campo"></a><?php }?>
								</div>
							</div>
						</div>
