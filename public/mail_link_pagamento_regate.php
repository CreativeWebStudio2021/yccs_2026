...
if(isset($_GET['nome_edizione'])) $nome_edizione=$_GET['nome_edizione']; else $nome_edizione='';
if(isset($_GET['anno_edizione'])) $anno_edizione=$_GET['anno_edizione']; else $anno_edizione='';
...
$testo_cli = "<br><br><br>Gentile utente<br/>
		<br><br>
		Per procedere al pagamento dell'iscrizione della regata <b>$nome_edizione $anno_edizione</b> cliccare sul seguente link.
		<br/><br/>
...
$oggetto_ut	= "YCCS - Link Pagamento Regatta ";
