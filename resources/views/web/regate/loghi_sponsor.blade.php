...
<div style="width:100%; text-align:center;">
	...
	@if($num_loghi>0)
		@if($num_loghi>1)
			...
			<div class="carousel team-members team-members-shadow p-t-20 m-b-0 carousel-loghi" data-items="{{ $num_carousel }}" style="border-bottom:solid 1px rgba(17,17,17,0.1)">
				@foreach($query_loghi AS $key_loghi=>$value_loghi)
					...
					<div class="team-member" style="border:none; box-shadow:none; background:none; margin-bottom:0;">
						<?php if($link_eng && trim($link_eng)!=""){?><a href="<?php if($lingua=="ita") echo $link; else echo $link_eng;?>" title="<?php echo $value_loghi->titolo;?>" target="_blank"><?php }?>
							<div class="team-image" style="margin-bottom:0;">
		...
		@else
			...
			<div style="padding:20px; text-align:center; border-bottom:solid 1px rgba(17,17,17,0.1)">
