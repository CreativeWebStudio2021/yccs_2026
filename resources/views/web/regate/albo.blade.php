<div>
	...
	@if($num_albo>0)
		...
		@if($query_albo[0]->tipo_link=="link" && $link!="")
		...
		@elseif($query_albo[0]->tipo_link=="allegato" && $pdf!="")
			@php
				$link_p = "resarea/files/regate/risultati/".$pdf;
				if($query_albo[0]->link_fisso=="1"){
					...
					$link_p .= $anno_regata."/".creaSlug($nome_regata,"")."-".$id_dett."/risultati-".$query_albo[0]->id."/".creaSlug($testo_link,"");
				}
			@endphp
