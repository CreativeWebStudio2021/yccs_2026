				...
				<div class="row team-members">
					...
					@foreach($query_cat AS $key_cat=>$value_cat)
						@php
							...
							if($num_g==1){
								$link_gal="young-azzurra/photogallery/".creaSlug($query_g[0]->titolo,"")."-".$query_g[0]->id.".html";
								if($lingua=="eng") $link_gal="en/".$link_gal;
							}
							...
							<div class="col-lg-6">
								<div class="team-member">
									<div class="team-image">
										<a href="<?php echo $link_gal;?>" title="<?php echo $titolo_gal;?> - Photogallery - Young Azzurra">
											<div style="position:relative; overflow: hidden; display: flex; justify-content: center; align-items: center;"> 
												<picture>
													  ...
													  <img 
														...
														alt="<?php echo $titolo_gal;?> - Photogallery - Young Azzurra"  
														style="position:absolute; width:100%; height:100%; top:0; left:0; object-fit:cover; object-position:center;"
													   />
												</picture>
												<img src="{{ smartAsset('/web/images/gallery_blank.jpg') }}" alt=""/>
											</div>
										</a>
									</div>
									<div class="team-desc">
										<a href="<?php echo $link_gal;?>" title="<?php echo $titolo_gal;?> - Photogallery - Young Azzurra">
											<h3 style="font-size:20px"><?php echo $titolo_gal;?></h3>
										</a>
										<a class="read-more" style="font-size:14px; color:#8D8D8D; font-family:'Open Sans'; font-weight:700" title="<?php echo $titolo_gal;?> - Photogallery - Young Azzurra" href="<?php echo $link_gal;?>"><?php if($lingua=="ita"){?>Sfoglia la Photogallery<?php }else{?>Browse the Photogallery<?php }?></a>
									</div>
								</div>
							</div>
						@endif
