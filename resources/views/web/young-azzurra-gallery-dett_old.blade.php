							...
							<div class="portfolio-item shadow img-zoom">
								<div class="portfolio-item-wrap">
									<div class="portfolio-image">
										<a href="#">
											<picture>
											  <source srcset="https://www.yccs.it/<?php  echo $dir_up; ?>/ya_gallery_foto/<?php echo $foto_gal_s;?>" media="(max-width: 360px)" />
											  <source srcset="https://www.yccs.it/<?php  echo $dir_up; ?>/ya_gallery_foto/<?php echo $foto_gal_m;?>" media="(max-width: 478px)" />
											  <source srcset="https://www.yccs.it/<?php  echo $dir_up; ?>/ya_gallery_foto/<?php echo $foto_gal_s;?>" media="(max-width: 990px)" />
											  <source srcset="https://www.yccs.it/<?php  echo $dir_up; ?>/ya_gallery_foto/<?php echo $foto_gal_xs;?>" media="(max-width: 1199px)" />
											  <img src="https://www.yccs.it/<?php  echo $dir_up; ?>/ya_gallery_foto/<?php echo $foto_gal_m;?>"  alt="{{ config('app.name') }} - Fotogallery - Foto <?php echo $g;?>"/>
											</picture>	
										</a>
									</div>
									<div class="portfolio-description">
										<a title="{{ $testo_foto }}" data-lightbox="gallery-image" href="<?php  echo $dir_up; ?>/ya_gallery_foto/<?php echo $foto_gal;?>"><i class="icon-maximize"></i></a>
									</div>
								</div>
							</div>
						@endforeach
